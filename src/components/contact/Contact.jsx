...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_10ze7ll', 'template_tjyn798', form.current, '02uD51XMKnjoIyic2')
        .then((result) => {
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <span className="section__subtitle">Send me a hello</span>
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">dev.soumallya@gmail.com</span>

              <a href="mailto:dev.soumallya@gmail.com" className="contact__button">
